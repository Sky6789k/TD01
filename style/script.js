...
const content = [
  { gif: 'https://i.pinimg.com/originals/7a/ef/73/7aef734a86dce4dc206976d4f0586f2c.gif', message: 'Dương ơi chắc chưa? 😢' },
  ...
  { gif: 'https://i.pinimg.com/originals/88/e7/86/88e786492cc527584feee199936813dd.gif', message: 'Thiệt luôn hả Mai Ka? 😭' },
...
noBtn.addEventListener('click', () => {
  ...
  if (clickCount === 3) {
    noBtn.textContent = 'Bấm Có đi Mai Ka😭';
  } else if (clickCount === 7) {
    noBtn.textContent = 'Năn nỉ đó bấm Có đi mà 😭';
  }
...
yesBtn.addEventListener('click', () => {
  question.textContent = 'Tớ biết mà! Tớ cũng thích cậu nhiều lắm Mai Ka❤️';
